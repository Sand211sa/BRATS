...
## 📌 Project Overview
This project focuses on developing an automated deep learning system for **multi-class brain tumor segmentation** using MRI images. It combines the strengths of **Convolutional Neural Networks (CNNs)** and **Transformers** using the **TransUNet architecture** to achieve accurate and efficient segmentation.
...
- ❌ Often limited to single-class segmentation  

👉 This project builds a **fully automated multi-class segmentation system** to assist in diagnosis, treatment planning, and monitoring.
...
- Provide fast and reliable predictions for healthcare applications  
...
- ☢️ Radiotherapy planning  
- 🔬 Medical research  
- 👨‍⚕️ Reducing workload of radiologists  
...
## 🏁 Conclusion
This project demonstrates that combining **CNN and Transformer architectures (TransUNet)** significantly improves multi-class brain tumor segmentation. The system shows strong potential for real-world clinical applications and can enhance efficiency in healthcare systems.
...
- PyTorch / TensorFlow  
- NumPy, OpenCV  
- NiBabel and medical imaging libraries  
